...
func InitializeEvent() Application {
	...
	aggregatePointController := controller17.NewController(conf, slogLogger, provider, client, cacher, kmutexProvider, organizationStorer, userStorer, dataPointStorer, aggregatePointStorer)
