...
import (
	...
	store "github.com/bci-innovation-labs/bp8fitnesscommunity-backend/app/fitnesschallenge/datastore"
...
func (h *Handler) List(w http.ResponseWriter, r *http.Request) {
	...
	f := &store.FitnessChallengeListFilter{
...
func MarshalListResponse(res *store.FitnessChallengeListResult, w http.ResponseWriter) {
