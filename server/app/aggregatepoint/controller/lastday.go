...
func (impl *AggregatePointControllerImpl) AggregateYesterdayForAllActiveFitBitApps(ctx context.Context) error {
	return nil
	...
	//
	// 	if err := impl.aggregateForMetric(ctx, fba.HeartRateMetricID, ap_s.PeriodDay, start, end); err != nil {
	// 		impl.Logger.Error("failed aggregating",
	// 			slog.Any("fitbit_app_id", fbaID),
	// 			slog.Any("error", err))
	// 	}
	// 	if err := impl.aggregateForMetric(ctx, fba.StepsCountMetricID, ap_s.PeriodDay, start, end); err != nil {
	// 		impl.Logger.Error("failed aggregating",
	// 			slog.Any("fitbit_app_id", fbaID),
	// 			slog.Any("error", err))
	// 	}
