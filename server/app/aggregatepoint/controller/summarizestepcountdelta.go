...
func (impl *AggregatePointControllerImpl) summarizeStepCountDelta(ctx context.Context, u *u_d.User, res *AggregatePointSummaryResponse) error {
	// --- Today --- //
	thisDayStart := timekit.Midnight(time.Now)
	thisDayEnd := timekit.MidnightTomorrow(time.Now)
	thisDay, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodDay, thisDayStart, thisDayEnd)
	if err != nil {
	...
	lastDay, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodDay, lastDayStart, lastDayEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
	...
	thisWeek, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodWeek, thisWeekStart, thisWeekEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
	...
	lastWeek, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodWeek, lastWeekStart, lastWeekEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
	...
	thisMonth, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodMonth, thisMonthStart, thisMonthEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
	...
	lastMonth, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodMonth, lastMonthStart, lastMonthEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
	...
	thisYear, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodYear, thisYearStart, thisYearEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
	...
	lastYear, err := impl.AggregatePointStorer.GetByCompositeKey(ctx, u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID, ap_s.PeriodYear, lastYearStart, lastYearEnd)
	if err != nil {
		impl.Logger.Error("failed getting aggregate point by composite key",
			slog.String("metric_id", u.PrimaryHealthTrackingDevice.StepCountDeltaMetricID.Hex()),
