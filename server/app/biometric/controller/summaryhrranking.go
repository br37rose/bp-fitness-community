...
func (impl *BiometricControllerImpl) generateSummaryRankingsForHRToday(sessCtx mongo.SessionContext, u *u_d.User, res *AggregatePointSummaryResponse, mu *sync.Mutex, wg *sync.WaitGroup) error {
	...
	if rp != nil {
		...
		rprp, err := impl.RankPointStorer.ListWithinPlaceAndToday(sessCtx, []string{gcp_a.DataTypeShortNameHeartRateBPM}, rp_d.FunctionAverage, rp_d.PeriodDay, startPlace, endPlace)
		if err != nil {
...
func (impl *BiometricControllerImpl) generateSummaryRankingsForHRISOWeek(sessCtx mongo.SessionContext, u *u_d.User, res *AggregatePointSummaryResponse, mu *sync.Mutex, wg *sync.WaitGroup) error {
	...
	if rp != nil {
		...
		rprp, err := impl.RankPointStorer.ListWithinPlaceAndISOWeek(sessCtx, []string{gcp_a.DataTypeShortNameHeartRateBPM}, rp_d.FunctionAverage, rp_d.PeriodWeek, startPlace, endPlace)
		if err != nil {
...
func (impl *BiometricControllerImpl) generateSummaryRankingsForHRMonth(sessCtx mongo.SessionContext, u *u_d.User, res *AggregatePointSummaryResponse, mu *sync.Mutex, wg *sync.WaitGroup) error {
	...
	if rp != nil {
		...
		rprp, err := impl.RankPointStorer.ListWithinPlaceAndMonth(sessCtx, []string{gcp_a.DataTypeShortNameHeartRateBPM}, rp_d.FunctionAverage, rp_d.PeriodMonth, startPlace, endPlace)
		if err != nil {
...
func (impl *BiometricControllerImpl) generateSummaryRankingsForHRYear(sessCtx mongo.SessionContext, u *u_d.User, res *AggregatePointSummaryResponse, mu *sync.Mutex, wg *sync.WaitGroup) error {
	...
	if rp != nil {
		...
		rprp, err := impl.RankPointStorer.ListWithinPlaceAndYear(sessCtx, []string{gcp_a.DataTypeShortNameHeartRateBPM}, rp_d.FunctionAverage, rp_d.PeriodYear, startPlace, endPlace)
		if err != nil {
