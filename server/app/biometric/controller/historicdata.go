...
func (c *BiometricControllerImpl) HistoricData(ctx context.Context, req *HistoricDataRequest) (*rp_s.RankPointPaginationListResult, error) {
	// Defensive code: Enforce input restrictions.
	if err := validateHistoricDataRequest(req); err != nil {
		return nil, err
	}
