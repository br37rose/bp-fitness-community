...
func (impl GoogleFitAppStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *GoogleFitAppListFilter) ([]*GoogleFitAppAsSelectOption, error) {
	...
	var results = []*GoogleFitAppAsSelectOption{}
