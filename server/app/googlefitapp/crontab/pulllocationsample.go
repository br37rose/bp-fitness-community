...
func (impl *googleFitAppCrontaberImpl) pullLocationSampleDataFromGoogleWithGfaAndFitnessStore(ctx context.Context, gfa *gfa_ds.GoogleFitApp, svc *fitness.Service) error {
