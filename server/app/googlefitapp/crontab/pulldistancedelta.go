...
func (impl *googleFitAppCrontaberImpl) pullDistanceDeltaDataFromGoogleWithGfaAndFitnessStore(ctx context.Context, gfa *gfa_ds.GoogleFitApp, svc *fitness.Service) error {
