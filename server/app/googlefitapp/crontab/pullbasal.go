...
func (impl *googleFitAppCrontaberImpl) pullBasalMetabolicRateDataFromGoogleWithGfaAndFitnessStore(ctx context.Context, gfa *gfa_ds.GoogleFitApp, svc *fitness.Service) error {
