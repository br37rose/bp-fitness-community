...
func (impl *googleFitAppCrontaberImpl) pullBodyFatPercentageDataFromGoogleWithGfaAndFitnessStore(ctx context.Context, gfa *gfa_ds.GoogleFitApp, svc *fitness.Service) error {
