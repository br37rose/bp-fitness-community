...
func (impl OfferStorerImpl) ListByFilter(ctx context.Context, f *OfferListFilter) (*OfferListResult, error) {
...
func (impl OfferStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *OfferListFilter) ([]*OfferAsSelectOption, error) {
	ctx, cancel := context.WithTimeout(context.Background(), 12*time.Second)
	defer cancel()
