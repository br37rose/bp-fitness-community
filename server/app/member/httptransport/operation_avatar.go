...
import (
	...
	c_c "github.com/bci-innovation-labs/bp8fitnesscommunity-backend/app/member/controller"
	u_s "github.com/bci-innovation-labs/bp8fitnesscommunity-backend/app/user/datastore"
	"github.com/bci-innovation-labs/bp8fitnesscommunity-backend/utils/httperror"
	"go.mongodb.org/mongo-driver/bson/primitive"
)

func UnmarshalOperationAvatarRequest(ctx context.Context, r *http.Request) (*c_c.MemberOperationAvatarRequest, error) {
	defer r.Body.Close()
	...
	requestData := &c_c.MemberOperationAvatarRequest{
		MemberID: memberID,
	}
	if header != nil {
