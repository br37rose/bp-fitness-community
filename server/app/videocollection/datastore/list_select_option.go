...
func (impl VideoCollectionStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *VideoCollectionListFilter) ([]*VideoCollectionAsSelectOption, error) {
	...
	var results = []*VideoCollectionAsSelectOption{}
