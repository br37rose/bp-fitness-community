...
func (impl NutritionPlanStorerImpl) ListByFilter(ctx context.Context, f *NutritionPlanListFilter) (*NutritionPlanListResult, error) {
	...
	return &NutritionPlanListResult{
		Results:     results,
