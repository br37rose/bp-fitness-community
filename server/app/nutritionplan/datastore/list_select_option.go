...
func (impl NutritionPlanStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *NutritionPlanListFilter) ([]*NutritionPlanAsSelectOption, error) {
	...
	var results = []*NutritionPlanAsSelectOption{}
