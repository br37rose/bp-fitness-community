...
// func (impl *RankPointControllerImpl) processGlobalRanksForFitBitApps(ctx context.Context, fbas []*fba_s.FitBitApp, metricType int8, function int8, period int8, start time.Time, end time.Time) error {
// 	return nil
...
// 	//
// 	// for _, fba := range fbas {
// 	// 	// // Lock this fitbit fba for modification and unlock when we are
// 	// 	// // finished with it.
// 	// 	// impl.Kmutex.Lockf("fitbitapp_%v", fba.ID.Hex())
// 	// 	// defer impl.Kmutex.Unlockf("fitbitapp_%v", fba.ID.Hex())
// 	//
...
// 	// 			////
// 	//
// 	// 			u, err := impl.UserStorer.GetByID(ctx, fba.UserID)
// 	// 			if err != nil {
...
// 	// 				OrganizationName:       fba.OrganizationName,
// 	// 			}
// 	//
// 	// 			switch function {
