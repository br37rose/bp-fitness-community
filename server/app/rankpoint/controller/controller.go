...
type RankPointController interface {
	...
	GenerateGlobalRankingForTodayUsingActiveFitBitApps(ctx context.Context) error
	GenerateGlobalRankingForThisISOWeekUsingActiveFitBitApps(ctx context.Context) error
	GenerateGlobalRankingForThisMonthUsingActiveFitBitApps(ctx context.Context) error
	GenerateGlobalRankingForThisYearUsingActiveFitBitApps(ctx context.Context) error
}
