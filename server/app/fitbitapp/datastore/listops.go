...
func (impl FitBitAppStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *FitBitAppListFilter) ([]*FitBitAppAsSelectOption, error) {
	...
	var results = []*FitBitAppAsSelectOption{}
