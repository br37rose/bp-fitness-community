...
func (impl FitBitAppStorerImpl) ListDevicesByStatus(ctx context.Context, status int8) ([]*FitBitAppDevice, error) {
	...
	results := make([]*FitBitAppDevice, 0)
