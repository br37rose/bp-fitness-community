...
import { faTasks, faArrowLeft, faCheckCircle, faArrowRight, faIdCard, faContactCard, faAddressBook, faChartPie } from '@fortawesome/free-solid-svg-icons'
        ...
        <>
            <div class="container">
                        ...
                        {!isFetching && <div class="container">
                            ...
                            <div class="columns">
                                <div class="column">
                                    ...
                                    {hasShippingAddress
                                        ? <p class="subtitle is-6"><FontAwesomeIcon className="fas" icon={faAddressBook} />&nbsp;Billing Address</p>
                                ...
                                {hasShippingAddress &&<div class="column">
                                    <p class="subtitle is-6"><FontAwesomeIcon className="fas" icon={faAddressBook} />&nbsp;Shipping Address</p>
                ...
                <div className="content has-text-centered">
                    <br />
                    <p>Need help?</p>
                    <p><Link to="mailto:mike@bp8fitness.com">mike@bp8fitness.com</Link></p>
                    <p><a href="tel:+16479672269">(647) 967-2269</a></p>
                </div>
            </div>
        </>
    );
