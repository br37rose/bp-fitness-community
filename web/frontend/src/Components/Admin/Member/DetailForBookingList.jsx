...
import { getWorkoutSessionBookingListAPI, deleteWorkoutSessionBookingAPI } from "../../../API/WorkoutSessionBooking";
...
import AdminMemberDetailForBookingListDesktop from "./DetailForBookingListDesktop";
import AdminMemberDetailForBookingListMobile from "./DetailForBookingListMobile";
...
function AdminMemberDetailForBookingList() {
    ...
    const onDeleteConfirmButtonClick = (e) => {
        ...
        deleteWorkoutSessionBookingAPI(
                ...
                <section class="section">
                    <nav class="breadcrumb" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class="is-active"><Link aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail (Bookings)</Link></li>
                        </ul>
                    </nav>
                    <nav class="box">
                        <div class={`modal ${selectedWorkoutSessionForDeletion ? 'is-active' : ''}`}>
                            ...
                            <div class="modal-card">
                                ...
                                <section class="modal-card-body">
                                    You are about to <b>archive</b> this workout schedule booking; it will no longer appear on your dashboard. This action can be undone but you'll need to contact the system administrator. Are you sure you would like to continue?
                                </section>
                        ...
                        <div class="columns is-mobile">
                            ...
                            <div class="column has-text-right">
                                ...
                                &nbsp;
                                {/*
                                <Link to={`/admin/branch/${bid}/class/${pid}/session/${sid}/bookings/add`} class="button is-small is-primary" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPlus} />&nbsp;New Booking
                                </Link>
                                */}
                            </div>
                        </div>
                            ...
                            : <>
                                <div class= "tabs is-medium is-size-7-mobile">
                                  <ul>
                                    ...
                                    <li class="is-active">
                                        <Link><strong>Bookings</strong></Link>
                                    </li>
                                    <li>
                                        <Link to={`/admin/branch/${bid}/member/${id}/waitlist`}>Waitlist</Link>
                                    </li>
                                    <li>
                                ...
                                {listData && listData.results && (listData.results.length > 0 || previousCursors.length > 0)
                                        ...
                                        <div class="container">
                                            ...
                                            */}
                                            <div class="is-hidden-touch" >
                                                <AdminMemberDetailForBookingListDesktop
                                                    listData={listData}
                                            ...
                                            */}
                                            <div class="is-fullwidth is-hidden-desktop">
                                                <AdminMemberDetailForBookingListMobile
                                                    listData={listData}
                                                    setPageSize={setPageSize}
                                                    pageSize={pageSize}
                                                    previousCursors={previousCursors}
                                    ...
                                    <section class="hero is-medium has-background-white-ter">
                                          <div class="hero-body">
                                            <p class="title">
                                                <FontAwesomeIcon className="fas" icon={faTable} />&nbsp;No Booking
                                            </p>
                                            <p class="subtitle">
                                                No booking. <b><Link to={`/admin/sessions/calendar`}>Click here&nbsp;<FontAwesomeIcon className="mdi" icon={faArrowRight} /></Link></b> to get started creating finding a full schedule to book.
                                            </p>
                                          </div>
                                    </section>
                                }
