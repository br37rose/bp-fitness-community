...
import { faTrash, faClock, faRepeat, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faTrophy, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
import { useRecoilState } from 'recoil';
import { useParams } from 'react-router-dom';

import { getFitnessPlanDetailAPI, deleteFitnessPlanAPI } from "../../../../API/FitnessPlan";
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to="/fitness-plans" aria-current="page"><FontAwesomeIcon className="fas" icon={faTrophy} />&nbsp;Fitness Plans</Link></li>
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to="/fitness-plans" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Fitness Plans</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav>
                        {/* Delete modal */}
                        <div class={`modal ${selectedFitnessPlanForDeletion !== null ? 'is-active' : ''}`}>
                            <div class="modal-background"></div>
                            <div class="modal-card">
                                <header class="modal-card-head">
                                    <p class="modal-card-title">Are you sure?</p>
                                    <button class="delete" aria-label="close" onClick={(e, ses) => setSelectedFitnessPlanForDeletion(null)}></button>
                                </header>
                                <section class="modal-card-body">
                                    You are about to delete this fitness plan and all the data associated with it. This action is cannot be undone. Are you sure you would like to continue?
                                </section>
                                <footer class="modal-card-foot">
                                    <button class="button is-success" onClick={onDeleteConfirmButtonClick}>Confirm</button>
                                    <button class="button" onClick={(e, ses) => setSelectedFitnessPlanForDeletion(null)}>Cancel</button>
                                </footer>
                            </div>
                        </div>
                    </nav>
                    ...
                    <nav class="box">
                        {datum && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faTrophy} />&nbsp;Fitness Plan</p>
                            </div>
                            {datum.status === FITNESS_GOAL_STATUS_ACTIVE && <div class="column has-text-right">
                                <Link to={`/fitness-plan/${id}/update`} class="button is-warning is-small is-fullwidth-mobile" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit & Re-request
                                </Link>&nbsp;
                                <Link onClick={(e,s)=>{setSelectedFitnessPlanForDeletion(datum)}} class="button is-danger is-small is-fullwidth-mobile" type="button">
                                        ...
                                        <section className="hero is-medium has-background-white-ter">
                                          <div className="hero-body">
                                            ...
                                            <p className="subtitle">
                                              You have successfully submitted this fitness plan to our team. The estimated time until our team completes your fitness plan will take about <b>1 or 2 days</b>. Please check back later.
                                            </p>
                                          </div>
                                        </section>
                                      </>
                                    ...
                                    */}
                                      ...
                                      && <>
                                        ...
                                        <div class= "tabs is-medium is-size-7-mobile">
                                          <ul>
                                            ...
                                            <li>
                                                <Link to={`/fitness-plan/${datum.id}/submission-form`}>Submission Form</Link>
                                            </li>
                                          </ul>
                                        </div>
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/fitness-plans`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to fitness plans</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            {datum.status === FITNESS_GOAL_STATUS_ACTIVE &&
                                                <Link to={`/fitness-plan/${id}/update`} class="button is-warning is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit & Re-request</Link>
                                            }
                                        </div>
                                    </div>
