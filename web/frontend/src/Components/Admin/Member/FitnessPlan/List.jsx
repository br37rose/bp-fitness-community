        ...
        <div className="container">
            <section className="section">
              ...
              <nav className="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                <ul>
                  <li className="">
                    <Link to="/admin/dashboard" aria-current="page"><FontAwesomeIcon className="fas" icon={faGauge} />&nbsp;Dashboard</Link>
                  </li>
                  <li class=""><Link to="/admin/members" aria-current="page"><FontAwesomeIcon className="fas" icon={faUsers} />&nbsp;Members</Link></li>
                  <li class=""><Link to={`/admin/member/${uid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Detail</Link></li>
                  <li className="is-active">
                    <Link aria-current="page"><FontAwesomeIcon className="fas" icon={faTrophy} />&nbsp;Fitness Plans</Link>
                  </li>
                </ul>
              </nav>
              ...
              <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                <ul>
                  <li class="">
                    <Link to="/admin/dashboard" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Dashboard</Link>
                  </li>
                </ul>
              </nav>
                      ...
                      <div className="container">
                        ...
                        <div class= "tabs is-medium is-size-7-mobile">
                          <ul>
                            ...
                            <li class="is-active">
                                <Link><strong>Fitness Plans</strong></Link>
                            </li>
                            <li>
                                <Link to={`/admin/member/${uid}/nutrition-plans`}>Nutrition Plans</Link>
                            </li>
                          </ul>
                        </div>
