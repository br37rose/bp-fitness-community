...
import { faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faTrophy, faIdCard, faAddressBook, faMessage, faChartPie, faCogs, faEye } from '@fortawesome/free-solid-svg-icons'
import { useRecoilState } from 'recoil';

import { getFitnessPlanDetailAPI, postFitnessPlanCreateAPI } from "../../../../API/FitnessPlan";
...
function AdminFitnessPlanAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postFitnessPlanCreateAPI(decamelizedData, onAdminFitnessPlanAddSuccess, onAdminFitnessPlanAddError, onAdminFitnessPlanAddDone);
    }

    function onAdminFitnessPlanAddSuccess(response){
        // For debugging purposes only.
        console.log("onAdminFitnessPlanAddSuccess: Starting...");
        ...
        setTimeout(() => {
            console.log("onAdminFitnessPlanAddSuccess: Delayed for 2 seconds.");
            console.log("onAdminFitnessPlanAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminFitnessPlanAddError(apiErr) {
        console.log("onAdminFitnessPlanAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onAdminFitnessPlanAddError: Delayed for 2 seconds.");
            console.log("onAdminFitnessPlanAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onAdminFitnessPlanAddDone() {
        console.log("onAdminFitnessPlanAddDone: Starting...");
        setFetching(false);
    }
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Request a Fitness Plan</p>
                            ...
                            <div class="columns pt-5">
                                ...
                                <div class="column is-half has-text-right">
                                    <button class="button is-medium is-primary is-fullwidth-mobile" onClick={onSubmitClick}>
                                        <FontAwesomeIcon className="fas" icon={faCheckCircle} />&nbsp;Save & Submit to Team
                                    </button>
                                </div>
                            </div>
...
export default AdminFitnessPlanAdd;
