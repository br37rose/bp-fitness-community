...
function AdminFitnessPlanAdd() {
  ...
  const onSubmitClick = (e) => {
    ...
    postFitnessPlanCreateAPI(
      decamelizedData,
      onAdminFitnessPlanAddSuccess,
      onAdminFitnessPlanAddError,
      onAdminFitnessPlanAddDone
    );
  };
  ...
  function onAdminFitnessPlanAddSuccess(response) {
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAdminFitnessPlanAddSuccess: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus
      );
      setTopAlertMessage("");
    ...
    setForceURL("/admin/fitness-plans" + response.id);
  }
  ...
  function onAdminFitnessPlanAddError(apiErr) {
    ...
    setTimeout(() => {
      ...
      console.log(
        "onAdminFitnessPlanAddError: topAlertMessage, topAlertStatus:",
        topAlertMessage,
        topAlertStatus
      );
      setTopAlertMessage("");
        ...
        <section class="section">
          <nav class="breadcrumb" aria-label="breadcrumbs">
            <ul>
              ...
              <li class="">
                <Link to="/fitness-plans" aria-current="page">
