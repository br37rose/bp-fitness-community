...
import { topAlertMessageState, topAlertStatusState, datumState } from "../../../AppState";
...
function AdminMemberTagList() {
    ...
    const onAddButtonClick = () => {
        ...
        if (!modifiedMember.hasOwnProperty('tags') || modifiedMember.tags === undefined || modifiedMember.tags === null  || modifiedMember.tags === "") {
            modifiedMember.tags = [];
        }
        ...
        // Make API call.
        onUpdateMember(modifiedMember, onAccountUpdateSuccess, onAccountUpdateError, onAccountUpdateDone);
    }
    ...
    const onDeleteConfirmButtonClick = () => {
        ...
        const updatedTags = modifiedMember.tags.filter(tag => tag.id !== selectedTagForDelete.id);
    ...
    const onUpdateMember = (member) => {
        ...
        putMemberUpdateAPI(decamelizedData, onAccountUpdateSuccess, onAccountUpdateError, onAccountUpdateDone);
    }
                    ...
                    <nav class="box">
                        ...
                        {datum && <div class="columns">
                            ...
                            <div class="column has-text-right">
                                <Link onClick={(e)=>setShowAddModal(true)}  class="button is-small is-success is-fullwidth-mobile" type="button">
                        ...
                        {isFetching
                            ...
                            : <>
                                {datum && <div class="container">
                                    ...
                                    <p class="title is-6"><FontAwesomeIcon className="fas" icon={faTable} />&nbsp;List</p>
                                    <hr />

                                    {datum.tags !== undefined && datum.tags !== null && datum.tags !== "" && datum.tags.length > 0
                                        ?
                                        <>
                                            {/* Non-Empty List */}
                                            {datum.tags.map((object, i) => <TagRow obj={object} index={i} setSelectedTagForDelete={setSelectedTagForDelete} onSetSelectedTagForEdit={onSetSelectedTagForEdit }/>)}
                                        </>
                                        :
                                        <>
                                            {/* Empty list */}
                                    ...
                                    <div class="columns pt-5">
                                        ...
                                        <div class="column is-half has-text-right">
                                            <Link onClick={(e)=>setShowAddModal(true)} class="button is-medium is-success is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;New Tag</Link>
                                        </div>
                                    </div>
