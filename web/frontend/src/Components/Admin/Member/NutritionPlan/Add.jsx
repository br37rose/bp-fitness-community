...
function MemberAdminNutritionPlanAdd() {
    ////
    //// Global state.
    ////
    ...
    const onSubmitClick = (e) => {
        ...
        postNutritionPlanCreateAPI(decamelizedData, onMemberAdminNutritionPlanAddSuccess, onMemberAdminNutritionPlanAddError, onMemberAdminNutritionPlanAddDone);
    }

    function onMemberAdminNutritionPlanAddSuccess(response){
        // For debugging purposes only.
        console.log("onMemberAdminNutritionPlanAddSuccess: Starting...");
        console.log(response);

        // Add a temporary banner message in the app and then clear itself after 2 seconds.
        setTopAlertMessage("AdminNutrition plan created");
        setTopAlertStatus("success");
        setTimeout(() => {
            console.log("onMemberAdminNutritionPlanAddSuccess: Delayed for 2 seconds.");
            console.log("onMemberAdminNutritionPlanAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onMemberAdminNutritionPlanAddError(apiErr) {
        console.log("onMemberAdminNutritionPlanAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onMemberAdminNutritionPlanAddError: Delayed for 2 seconds.");
            console.log("onMemberAdminNutritionPlanAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onMemberAdminNutritionPlanAddDone() {
        console.log("onMemberAdminNutritionPlanAddDone: Starting...");
        setFetching(false);
    }
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="box">
                        ...
                        <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Request a AdminNutrition Plan</p>
...
export default MemberAdminNutritionPlanAdd;
