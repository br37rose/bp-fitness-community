...
import { faRepeat, faTasks, faTachometer, faPlus, faArrowLeft, faCheckCircle, faUserCircle, faGauge, faPencil, faUsers, faEye, faIdCard, faAddressBook, faContactCard, faChartPie, faCogs } from '@fortawesome/free-solid-svg-icons'
...
function AdminMemberDetail() {
    ...
    const [selectedMemberForDeletion, setSelectedMemberForDeletion] = useState(null);
            ...
            <div class="container">
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-desktop" aria-label="breadcrumbs">
                        <ul>
                            <li class=""><Link to="/admin/members" aria-current="page"><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Members</Link></li>
                        </ul>
                    </nav>
                    ...
                    <nav>
                        {/* Delete modal */}
                        <div class={`modal ${selectedMemberForDeletion !== null ? 'is-active' : ''}`}>
                            <div class="modal-background"></div>
                            <div class="modal-card">
                                <header class="modal-card-head">
                                    <p class="modal-card-title">Are you sure?</p>
                                    <button class="delete" aria-label="close" onClick={(e, ses) => setSelectedMemberForDeletion(null)}></button>
                                </header>
                                ...
                                <footer class="modal-card-foot">
                                    ...
                                    <button class="button" onClick={(e, ses) => setSelectedMemberForDeletion(null)}>Cancel</button>
                                </footer>
                            </div>
                        </div>
                    </nav>
                    ...
                    <nav class="box">
                        {datum && <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faUsers} />&nbsp;Member</p>
                            </div>
                            <div class="column has-text-right">
                                <Link to={`/admin/member/${id}/update`} class="button is-warning is-fullwidth-mobile is-small" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit Member
                                </Link>&nbsp;
                                <Link onClick={(e,s)=>{setSelectedMemberForDeletion(datum)}} class="button is-danger is-fullwidth-mobile is-small" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Delete Member
                                </Link>
                            </div>
                        </div>}
                        ...
                        {isFetching
                            ...
                            <>
                                {datum && <div class="container" key={datum.id}>
                                    ...
                                    {datum.howDidYouHearAboutUs === 1 && <FormTextRow
                                    ...
                                    {datum !== undefined && datum !== null && datum !== "" && <>
                                        {datum.stripeSubscription !== undefined && datum.stripeSubscription !== null && datum.stripeSubscription !== "" && <>
                                            <p class="subtitle is-6"><FontAwesomeIcon className="fas" icon={faRepeat} />&nbsp;Subscription</p>
                                            <hr />
                                            <FormTextOptionRow
                                                label="Interval"
                                                selectedValue={datum.stripeSubscription.interval}
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/members`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Members</Link>
                                        </div>
                                        <div class="column is-half has-text-right">
                                            <Link to={`/admin/member/${id}/update`} class="button is-warning is-fullwidth-mobile"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit</Link>
                                        </div>
                                    </div>
