...
import { putVideoContentUpdateAPI, getVideoContentDetailAPI } from "../../../../API/VideoContent";
...
function AdminVideoContentUpdate() {
    ...
    console.log("vcid:", vcid, "vconid:", vconid);
    ...
    function onVideoContentDetailSuccess(response){
        ...
        setVideoAttachmentName(response.videoAttachmentName);
    ...
    function onAddSuccess(response){
        ...
        setTopAlertMessage("Video content update");
                ...
                <section class="section">
                    ...
                    <nav class="breadcrumb is-hidden-touch" aria-label="breadcrumbs">
                        <ul>
                            ...
                            <li class=""><Link to={`/admin/video-collection/${vcid}/video-content/${vconid}`} aria-current="page"><FontAwesomeIcon className="fas" icon={faEye} />&nbsp;Video Content</Link></li>
                    ...
                    <nav class="box">
                        <div class="columns">
                            <div class="column">
                                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faVideoCamera} />&nbsp;Video Content</p>
                            </div>
                                    ...
                                    */}
                                    ...
                                    <div class="columns pt-5">
                                        <div class="column is-half">
                                            <Link class="button is-fullwidth-mobile" to={`/admin/video-collection/${vcid}/video-content/${vconid}`}><FontAwesomeIcon className="fas" icon={faArrowLeft} />&nbsp;Back to Detail</Link>
                                        </div>
