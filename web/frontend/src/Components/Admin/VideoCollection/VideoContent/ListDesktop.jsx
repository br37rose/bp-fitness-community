...
function AdminVideoContentListDesktop(props) {
            ...
            {listData &&
              ...
              listData.results.map(function (datum, i) {
                return (
                    ...
                    <td data-label="Video Type">{VIDEO_CONTENT_VIDEO_TYPE_MAP[datum.videoType]}</td>
                    <td data-label="Offer">
                        {datum.offerName
                            ?
                                <>
                    ...
                    <td className="is-actions-cell">
                      <div className="buttons is-right">
                        ...
                        <Link to={`/admin/video-collection/${datum.collectionId}/video-content/${datum.id}`} className="button is-small is-dark" type="button">
...
export default AdminVideoContentListDesktop;
