...
*/
function AdminVideoContentListMobile(props) {
            ...
            {listData && listData.results && listData.results.map(function (datum, i) {
                return <div class="pb-2" key={`mobile_tablet_${datum.id}`}>
                    ...
                    {datum.categoryName
                        ?
                            <>
                                <Link to={`/admin/video-category/${datum.categoryId}`} target="_blank" rel="noreferrer">
                    ...
                    <br />
                    <br />
                    <strong>Video Type:</strong>&nbsp;{VIDEO_CONTENT_VIDEO_TYPE_MAP[datum.videoType]}
                    <br />
                    <br />
                    <strong>Offer:</strong>&nbsp;
                    {datum.offerName
                        ?
                            <>
                                <Link to={`/admin/offer/${datum.offerId}`} target="_blank" rel="noreferrer">
                    ...
                    <div class="is-hidden-mobile" key={`tablet_${datum.id}`}>
                        <div className="buttons is-right">
                            <Link to={`/admin/video-collection/${datum.collectionId}/video-content/${datum.id}`} class="button is-small is-dark" type="button">
                    ...
                    <div class="is-hidden-tablet" key={`mobile_${datum.id}`}>
                        <div class="columns is-mobile">
                            <div class="column">
                                <Link to={`/admin/video-collection/${datum.collectionId}/video-content/${datum.id}`} class="button is-small is-dark is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faEye} />&nbsp;View
                                </Link>
                            </div>
                            {/*
...
export default AdminVideoContentListMobile;
