...
import { faVideo, faDumbbell, faGauge, faArrowRight, faUsers, faChalkboardTeacher } from '@fortawesome/free-solid-svg-icons';
          ...
          <nav class="box">
            ...
            */}
            ...
            <section class="hero is-medium is-dark">
              <div class="hero-body">
                <p class="title">
                  <FontAwesomeIcon className="fas" icon={faChalkboardTeacher} />&nbsp;Exercises
                </p>
                <p class="subtitle">
                  Manage the exercises by clicking below:
                  <br />
                  <br />
                  <Link to={"/admin/exercises"}>View&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                  <br />
                  <br />
                  <Link to={"/admin/exercises/add"}>Add&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                </p>
              </div>
            </section>
            ...
            <section class="hero is-medium is-primary">
              <div class="hero-body">
                <p class="title">
                  <FontAwesomeIcon className="fas" icon={faVideo} />&nbsp;Video Collections
                </p>
                <p class="subtitle">
                  Manage the videos that belong to your system.
                  <br />
                  <br />
                  <Link to={"/admin/video-collections"}>View&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                  <br />
                  <br />
                  <Link to={"/admin/video-collections/add"}>Add&nbsp;<FontAwesomeIcon className="fas" icon={faArrowRight} /></Link>
                </p>
              </div>
            </section>
