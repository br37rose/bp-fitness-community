...
import { getfitnessChallengeListApi } from "../../../API/FitnessChallenge";

function FitenessChallengeAdminList() {
  ////
  //// Global state.
  ////
                  ...
                  <section className="hero is-medium has-background-white-ter">
                    <div className="hero-body">
                      ...
                      <p className="subtitle">
                        No class types.{" "}
                        <b>
                          <Link to="/admin/fitness-challenge/add">
                            Click here&nbsp;
                            <FontAwesomeIcon
                              className="mdi"
                              icon={faArrowRight}
                        ...
                        to get started creating your first FitenessChallenge.
                      </p>
                    </div>
                  </section>
                )}
...
export default FitenessChallengeAdminList;
