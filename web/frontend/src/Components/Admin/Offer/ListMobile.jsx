                ...
                return <div class="pb-2" key={`mobile_tablet_${datum.id}`}>                    
                    ...
                    <div class="is-hidden-mobile" key={`tablet_${datum.id}`}>
                        <div className="buttons is-right">
                            ...
                            <Link to={`/admin/offer/${datum.id}/update`} class="button is-small is-warning" type="button">
                                <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                            </Link>
                            <button onClick={(e, ses) => onSelectOfferForDeletion(e, datum)} class="button is-small is-danger" type="button">
                    ...
                    <div class="is-hidden-tablet" key={`mobile_${datum.id}`}>
                        <div class="columns is-mobile">
                            ...
                            <div class="column">
                                <Link to={`/admin/offer/${datum.id}/update`} class="button is-small is-warning is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faPencil} />&nbsp;Edit
                                </Link>
                            </div>
                            <div class="column">
                                <button onClick={(e, ses) => onSelectOfferForDeletion(e, datum)} class="button is-small is-danger is-fullwidth" type="button">
                                    <FontAwesomeIcon className="mdi" icon={faTrashCan} />&nbsp;Delete
                                </button>
                            </div>
                        </div>
