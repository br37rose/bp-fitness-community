...
function MemberVideoCollectionListDesktop(props) {
            ...
            {listData &&
              ...
              listData.results.map(function (datum, i) {
                return (
                    ...
                    <td data-label="Type">{VIDEO_COLLECTION_TYPE_MAP[datum.type]}</td>
                    <td data-label="Status">{VIDEO_COLLECTION_STATUS_MAP[datum.status]}</td>
                    <td className="is-actions-cell">
                      <div className="buttons is-right">

                        <Link
                          to={`/video-collection/${datum.id}`}
...
export default MemberVideoCollectionListDesktop;
