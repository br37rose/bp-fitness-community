...
function MemberNutritionPlanAdd() {
	...
	const [consumeFruitsAndVegetables, setConsumeFruitsAndVegetables] =
		useState(0);
	...
	function onMemberNutritionPlanAddSuccess(response) {
		...
		setTimeout(() => {
			...
			console.log(
				"onMemberNutritionPlanAddSuccess: topAlertMessage, topAlertStatus:",
				topAlertMessage,
				topAlertStatus
			);
			setTopAlertMessage("");
	...
	function onMemberNutritionPlanAddError(apiErr) {
		...
		setTimeout(() => {
			...
			console.log(
				"onMemberNutritionPlanAddError: topAlertMessage, topAlertStatus:",
				topAlertMessage,
				topAlertStatus
			);
			setTopAlertMessage("");
					...
					<div class="modal-card">
						<header class="modal-card-head">
							...
							<button
								class="delete"
								aria-label="close"
								onClick={(e) => setShowCancelWarning(false)}></button>
						</header>
						...
						<footer class="modal-card-foot">
							<Link class="button is-medium is-success" to={`/nutrition-plans`}>
								Yes
							</Link>
							<button
				...
				<div>
					...
					<div class="columns pt-5">
						...
						<div class="column is-half has-text-right">
							...
							<Link class="button is-success is-fullwidth is-hidden-desktop">
								<FontAwesomeIcon className="fas" icon={faCheckCircle} />
								&nbsp;Save & Submit to Team
							</Link>
						</div>
