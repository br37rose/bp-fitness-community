...
import { faTasks, faTachometer, faPlus, faTimesCircle, faCheckCircle, faUserCircle, faGauge, faPencil, faLeaf, faIdCard, faAddressBook, faMessage, faChartPie, faCogs, faEye, faArrowLeft } from '@fortawesome/free-solid-svg-icons'
import { useRecoilState } from 'recoil';

import { getNutritionPlanDetailAPI, postNutritionPlanCreateAPI } from "../../../API/NutritionPlan";
...
function MemberNutritionPlanAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postNutritionPlanCreateAPI(decamelizedData, onMemberNutritionPlanAddSuccess, onMemberNutritionPlanAddError, onMemberNutritionPlanAddDone);
    }

    function onMemberNutritionPlanAddSuccess(response) {
        // For debugging purposes only.
        console.log("onMemberNutritionPlanAddSuccess: Starting...");
        console.log(response);

        // Add a temporary banner message in the app and then clear itself after 2 seconds.
        setTopAlertMessage("Nutrition plan created");
        setTopAlertStatus("success");
        setTimeout(() => {
            console.log("onMemberNutritionPlanAddSuccess: Delayed for 2 seconds.");
            console.log("onMemberNutritionPlanAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onMemberNutritionPlanAddError(apiErr) {
        console.log("onMemberNutritionPlanAddError: Starting...");
        setErrors(apiErr);
        ...
        setTimeout(() => {
            console.log("onMemberNutritionPlanAddError: Delayed for 2 seconds.");
            console.log("onMemberNutritionPlanAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onMemberNutritionPlanAddDone() {
        console.log("onMemberNutritionPlanAddDone: Starting...");
        setFetching(false);
    }
    ...
    const breadcrumbItems = {
        items: [
            ...
            { text: 'New', link: '#', icon: faPlus, isActive: true }
        ],
        mobileBackLinkItems: {
    ...
    return (
        <Layout breadcrumbItems={breadcrumbItems}>
            <div class="box">
                ...
                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPlus} />&nbsp;Request a Nutrition Plan</p>
