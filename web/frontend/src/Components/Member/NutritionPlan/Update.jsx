...
function AdminNutritionPlanUpdate() {
    ...
    const breadcrumbItems = {
        items: [
            ...
            { text: 'Detail', link: `/nutrition-plan/${id}`, icon: faEye, isActive: false },
    ...
    return (
        <Layout breadcrumbItems={breadcrumbItems}>
            <div class="box">
                ...
                <p class="title is-4"><FontAwesomeIcon className="fas" icon={faPencil} />&nbsp;Edit & Re-request an Updated Nutrition Plan</p>
