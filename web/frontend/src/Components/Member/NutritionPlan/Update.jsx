...
function AdminNutritionPlanUpdate() {
	...
	function onAdminNutritionPlanUpdateSuccess(response) {
		...
		setTopAlertMessage("Nutrition plan update");
		setTopAlertStatus("success");
		setTimeout(() => {
			console.log("onAdminNutritionPlanUpdateSuccess: Delayed for 2 seconds.");
			console.log(
				"onAdminNutritionPlanUpdateSuccess: topAlertMessage, topAlertStatus:",
				topAlertMessage,
				topAlertStatus
			);
			setTopAlertMessage("");
	...
	function onAdminNutritionPlanUpdateError(apiErr) {
		...
		setTimeout(() => {
			...
			console.log(
				"onAdminNutritionPlanUpdateError: topAlertMessage, topAlertStatus:",
				topAlertMessage,
				topAlertStatus
			);
			setTopAlertMessage("");
		...
		<Layout breadcrumbItems={breadcrumbItems}>
			<div class="box">
				<div class={`modal ${showCancelWarning ? "is-active" : ""}`}>
					...
					<div class="modal-card">
						...
						<section class="modal-card-body">
							Your form input will be lost and nothing will be updated. This
				...
				<p class="title is-4">
					...
					&nbsp;Edit & Re-request an Updated Nutrition Plan
				</p>
