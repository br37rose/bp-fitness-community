...
function MemberFitnessPlanAdd() {
    ...
    const onSubmitClick = (e) => {
        ...
        postFitnessPlanCreateAPI(decamelizedData, onMemberFitnessPlanAddSuccess, onMemberFitnessPlanAddError, onMemberFitnessPlanAddDone);
    }
    ...
    function onMemberFitnessPlanAddSuccess(response) {
        ...
        setTimeout(() => {
            ...
            console.log("onMemberFitnessPlanAddSuccess: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
    ...
    function onMemberFitnessPlanAddError(apiErr) {
        ...
        setTimeout(() => {
            ...
            console.log("onMemberFitnessPlanAddError: topAlertMessage, topAlertStatus:", topAlertMessage, topAlertStatus);
            setTopAlertMessage("");
        }, 2000);
