          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt1Label] && options[opt1Label] === value}
                name={name}
                value={opt1Value}
                onChange={onChange}
              />
          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt2Label] && options[opt2Label] === value}
                name={name}
                value={opt2Value}
                onChange={onChange}
              />
          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt3Label] && options[opt3Label] === value}
                name={name}
                value={opt3Value}
                onChange={onChange}
              />
          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt4Label] && options[opt4Value] === value}
                name={name}
                value={opt4Value}
                onChange={onChange}
              />
          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt5Label] && options[opt5Label] === value}
                name={name}
                value={opt5Value}
                onChange={onChange}
              />
          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt6Label] && options[opt6Label] === value}
                name={name}
                value={opt6Value}
                onChange={onChange}
              />
          ...
          <>
            <label class="radio">
              <input
                ...
                checked={options[opt7Label] && options[opt7Label] === value}
                name={name}
                value={opt7Value}
                onChange={onChange}
              />
