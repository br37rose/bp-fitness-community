...
import { faEllipsis, faArrowLeft, faUserCircle, faGauge, faKey } from '@fortawesome/free-solid-svg-icons'
            ...
            <div class="box">
                ...
                {currentUser && <div class="columns">
                    ...
                    <div class="column has-text-right-tablet has-text-right-desktop">
                        <Link class="button is-success is-hidden-touch" to={"/account/change-password"}><FontAwesomeIcon className="mdi" icon={faKey} />&nbsp;Change Password</Link>
                        <Link to={"/account/change-password"} class="button is-success is-fullwidth is-hidden-desktop"><FontAwesomeIcon className="mdi" icon={faKey} />&nbsp;Change Password</Link>
                    </div>
                </div>}
                                            ...
                                            <div class="tabs is-centered is-boxed">
                                                <ul>
                                                    <li className={activeTab === 'detail' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('detail')}><strong>Detail</strong></a>
                                                    </li>
                                                    <li className={activeTab === 'tags' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('tags')}><strong>Tags</strong></a>
                                                    </li>
                                                    <li className={activeTab === 'friends' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('friends')}><strong>Friends</strong></a>
                                                    </li>
                                                    <li className={activeTab === 'wearableTech' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('wearableTech')}><strong>Wearable Tech</strong></a>
                                                    </li>
                                                    <li className={activeTab === 'survey' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('survey')}><strong>Survey</strong></a>
                                                    </li>
                                                    <li className={activeTab === 'subscription' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('subscription')}><strong>Subscription</strong></a>
                                                    </li>
                                                    <li className={activeTab === 'more' ? 'is-active' : ''}>
                                                        <a onClick={() => setActiveTab('more')}><strong>More&nbsp;<FontAwesomeIcon className="fas" icon={faEllipsis} /></strong></a>
                                                    </li>
                                                </ul>
                                            </div>
                                            <div>
