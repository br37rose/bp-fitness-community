import {
  ...
  FITNESS_GOAL_WEIGHT_LOSS,
  FITNESS_GOAL_MUSCLE_MASS_OR_STRENGTH,
  FITNESS_GOAL_CARDIOVASCULAR,
  FITNESS_GOAL_INJURY_RECOVERY,
  FITNESS_GOAL_SPORT_SPECIFIC,
  FITNESS_GOAL_AGILITY,
  FITNESS_GOAL_POWER,
  FITNESS_GOAL_SPEED,
  FITNESS_GOAL_BALANCE_OR_MOVEMENT,
  WORKOUT_PREFERENCE_FULL_BODY_WORKOUT,
  WORKOUT_PREFERENCE_FULL_HIIT,
...
export const CLASSES_AND_EVENTS = [
  ...
  },
  {
    ...
    title: "20 Classes",
    subTitle:
      "Train with us when it works for you! Passes are valid for 6 months from date of purchase.",
...
const OFFER_MEMBERSHIP_RANK_OPTIONS = [
  // Membership Rank No
...
export const FITNESS_GOAL_OPTIONS = [
  ...
  {
    value: FITNESS_GOAL_MUSCLE_MASS_OR_STRENGTH,
...
export const FITNESS_PLAN_STATUS_MAP = {
  ...
  [FITNESS_GOAL_STATUS_IN_PROGRESS]: "In Progress",
  [FITNESS_GOAL_STATUS_PENDING]: "Pending",
};
