                            ...
                            <section class="main-content columns is-fullheight">
                                <Routes>
                                    ...
                                    */}
                                    ...
                                    <Route exact path="/admin/video-collection/:vcid/video-content/:vconid/update" element={<AdminVideoContentUpdate />} />
                                    <Route exact path="/admin/video-collection/:vcid/video-content/:vconid" element={<AdminVideoContentDetail />} />
                                    <Route exact path="/admin/video-collection/:vcid/video-contents/add" element={<AdminVideoContentAdd />} />
                                    <Route exact path="/admin/video-collection/:vcid/video-contents" element={<AdminVideoContentList />} />

                                    <Route exact path="/admin/video-collection/:vcid/update" element={<AdminVideoCollectionUpdate />} />
                                    <Route exact path="/admin/video-collection/:vcid" element={<AdminVideoCollectionDetail />} />
                                    <Route exact path="/admin/video-collections/add" element={<AdminVideoCollectionAdd />} />
                                    <Route exact path="/admin/video-collections" element={<AdminVideoCollectionList />} />

                                    <Route exact path="/admin/video-category/:id/update" element={<AdminVideoCategoryUpdate />} />
                                    <Route exact path="/admin/video-category/:id" element={<AdminVideoCategoryDetail />} />
                                    <Route exact path="/admin/video-categories/add" element={<AdminVideoCategoryAdd />} />
                                    <Route exact path="/admin/video-categories" element={<AdminVideoCategoryList />} />

                                    <Route exact path="/admin/exercise/:id/update" element={<AdminExerciseUpdate />} />
                                    <Route exact path="/admin/exercise/:id" element={<AdminExerciseDetail />} />
                                    <Route exact path="/admin/exercises/add" element={<AdminExerciseAdd />} />
                                    <Route exact path="/admin/exercises" element={<AdminExerciseList />} />

                                    <Route exact path="/admin/member/:uid/nutrition-plan/:id/update" element={<AdminNutritionPlanUpdate />} />
                                    <Route exact path="/admin/member/:uid/nutrition-plan/:id/submission-form" element={<AdminNutritionPlanSubmissionForm />} />
                                    <Route exact path="/admin/member/:uid/nutrition-plan/:id" element={<AdminNutritionPlanDetail />} />
                                    <Route exact path="/admin/member/:uid/nutrition-plans/add" element={<AdminNutritionPlanAdd />} />
                                    <Route exact path="/admin/member/:uid/nutrition-plans" element={<AdminNutritionPlanList />} />

                                    <Route exact path="/admin/member/:uid/fitness-plan/:id/update" element={<AdminFitnessPlanUpdate />} />
                                    <Route exact path="/admin/member/:uid/fitness-plan/:id/submission-form" element={<AdminFitnessPlanSubmissionForm />} />
                                    <Route exact path="/admin/member/:uid/fitness-plan/:id" element={<AdminFitnessPlanDetail />} />
                                    <Route exact path="/admin/member/:uid/fitness-plans/add" element={<AdminFitnessPlanAdd />} />
                                    <Route exact path="/admin/member/:uid/fitness-plans" element={<AdminFitnessPlanList />} />

                                    <Route exact path="/admin/member/:id/update" element={<AdminMemberUpdate />} />
                                    <Route exact path="/admin/member/:id/tags" element={<AdminMemberTagList />} />
                                    <Route exact path="/admin/member/:id" element={<AdminMemberDetail />} />
                                    <Route exact path="/admin/members" element={<AdminMemberList />} />
                                    <Route exact path="/admin/members/add" element={<AdminMemberAdd />} />
                                    ...
                                    */}
                                    ...
                                    <Route exact path="/biometrics/leaderboard/global" element={<MemberLeaderboardGlobalTabularList />} />
                                    <Route exact path="/biometrics/leaderboard/personal" element={<MemberLeaderboardPersonal />} />
                                    <Route exact path="/biometrics/summary" element={<MemberSummary />} />
                                    <Route exact path="/biometrics/history/graphview" element={<MemberDataPointHistoricalGraphicalList />} />
                                    <Route exact path="/biometrics/history/tableview" element={<MemberDataPointHistoricalTabularList />} />
                                    <Route exact path="/biometrics" element={<MemberBiometricLaunchpad />} />

                                    <Route exact path="/nutrition-plan/:id/update" element={<MemberNutritionPlanUpdate />} />
                                    <Route exact path="/nutrition-plan/:id/submission-form" element={<MemberNutritionPlanSubmissionForm />} />
                                    <Route exact path="/nutrition-plan/:id" element={<MemberNutritionPlanDetail />} />
                                    <Route exact path="/nutrition-plans/add" element={<MemberNutritionPlanAdd />} />
                                    <Route exact path="/nutrition-plans" element={<MemberNutritionPlanList />} />

                                    <Route exact path="/fitness-plan/:id/update" element={<MemberFitnessPlanUpdate />} />
                                    <Route exact path="/fitness-plan/:id/submission-form" element={<MemberFitnessPlanSubmissionForm />} />
                                    <Route exact path="/fitness-plan/:id" element={<MemberFitnessPlanDetail />} />
                                    <Route exact path="/fitness-plans/add" element={<MemberFitnessPlanAdd />} />
                                    <Route exact path="/fitness-plans" element={<MemberFitnessPlanList />} />

                                    {/* <Route exact path="/video-collection/:vcid/video-content/:vconid" element={<MemberVideoContentDetail />} /> */}
                                    <Route exact path="/video-collection/:vcid/video-content/:vconid" element={<MemberVideoCollectionContentList />} />

                                    <Route exact path="/video-collection/:vcid/video-contents" element={<MemberVideoContentList />} />

                                    <Route exact path="/video-collection/:vcid" element={<MemberVideoCollectionDetail />} />
                                    <Route exact path="/video-categories" element={<MemberCategoriesList />} />
                                    <Route exact path="/video-category/:vcatid/video-collections" element={<MemberVideoCollectionList />} />

                                    <Route exact path="/exercise/:id" element={<MemberExerciseDetail />} />
                                    ...
                                    */}
                                    ...
                                    <Route exact path="/purchase/success" element={<PaymentProcessorPurchaseSuccess />} />
                                    <Route exact path="/purchase/canceled" element={<PaymentProcessoePurchaseCanceled />} />
                                    <Route exact path="/account/more/subscribe" element={<AccountMoreOperationSubscribe />} />
                                    <Route exact path="/account/more/avatar" element={<AccountMoreOperationAvatar />} />
                                    <Route exact path="/account/more" element={<AccountMoreLaunchpad />} />
                                    <Route exact path="/account/wearable-tech" element={<AccountWearableTechLaunchpad />} />
                                    <Route exact path="/account/friends" element={<AccountFriendList />} />
