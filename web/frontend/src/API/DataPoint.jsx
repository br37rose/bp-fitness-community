...
import {
    BP8_FITNESS_DATA_POINTS_API_ENDPOINT,
} from "../Constants/API";


export function getDataPointListAPI(filtersMap = new Map(), onSuccessCallback, onErrorCallback, onDoneCallback) {
    const axios = getCustomAxios();

    // The following code will generate the query parameters for the url based on the map.
    let aURL = BP8_FITNESS_DATA_POINTS_API_ENDPOINT;
    filtersMap.forEach(
        (value, key) => {
