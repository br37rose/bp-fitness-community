...
export function postLoginAPI(
  ...
  axios
    .post(BP8_FITNESS_LOGIN_API_ENDPOINT, decamelizedData)
...
export function postRegisterAPI(
  ...
  axios
    .post(BP8_FITNESS_REGISTER_MEMBER_API_ENDPOINT, decamelizedData)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function getVersionAPI(
  ...
  const axios = getCustomAxios();
  axios
    .get(BP8_FITNESS_VERSION_ENDPOINT)
    .then((successResponse) => {
      const responseData = successResponse.data;
...
export function postEmailVerificationAPI(
  ...
  axios
    .post(BP8_FITNESS_EMAIL_VERIFICATION_API_ENDPOINT, data)
    .then((successResponse) => {
...
export function postLogoutAPI(
  ...
  let data = {};
  axios
    .post(BP8_FITNESS_LOGOUT_API_ENDPOINT, data)
    .then((successResponse) => {
      onSuccessCallback(null);
    })
    .catch((exception) => {
...
export function postForgotPasswordAPI(
  ...
  axios
    .post(BP8_FITNESS_FORGOT_PASSWORD_API_ENDPOINT, { email: email })
    .then((successResponse) => {
...
export function postPasswordResetAPI(
  ...
  axios
    .post(BP8_FITNESS_PASSWORD_RESET_API_ENDPOINT, {
