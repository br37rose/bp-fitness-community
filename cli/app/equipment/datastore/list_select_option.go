...
func (impl EquipmentStorerImpl) ListAsSelectOptionByFilter(ctx context.Context, f *EquipmentListFilter) ([]*EquipmentAsSelectOption, error) {
	...
	var results = []*EquipmentAsSelectOption{}
